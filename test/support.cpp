...
void bookshelf_fixture(const std::filesystem::path &dir) {
  write(dir / "tiny.aux", "# arbitrary component order\n"
                          "RowBasedPlacement : tiny.pl tiny.scl tiny.wts tiny.nets tiny.nodes\n");
  write(dir / "tiny.nodes", "UCLA nodes 1.0\n"
                            "# cells\n"
                            "NumNodes : 4\nNumTerminals : 2\n"
                            "a 2 4\nb 6 3 terminal\nc 5 2 terminal_NI\nd 1.5 2.5e0\n");
  write(dir / "tiny.nets", "UCLA nets 1.0\nNumNets : 2\nNumPins : 4\n"
                           "NetDegree : 3 net0\n"
                           "a I : -0.5 1\nb O : 2 0\nc B : 0 0\n"
                           "NetDegree : 1 net1\nd U\n");
  write(dir / "tiny.wts", "UCLA wts 1.0\na 1 2\nb 3 4\nnet0 2.5\nnet1 1.5\n");
  write(dir / "tiny.scl", "UCLA scl 1.0\nNumRows : 1\nCoreRow Horizontal\n"
                          " Coordinate : 10\n Height : 4\n Sitespacing : 2\n"
                          " Siteorient : FS\n Sitesymmetry : X Y ROT90\n"
                          " SubrowOrigin : 5 NumSites : 3\n"
                          " SubrowOrigin : 20 NumSites : 2\nEnd\n");
  write(dir / "tiny.pl", "UCLA pl 1.0\n"
                         "a 10.5 20 : E\n"
                         "b 30 10 : N /FIXED\n"
...
void lefdef_fixture(const std::filesystem::path &dir) {
  write(dir / "tech.lef", "VERSION 5.8 ;\n"
                          ...
                          "END core\n"
                          "END LIBRARY\n");
  write(dir / "cells.lef", "VERSION 5.8 ;\n"
                           "MACRO NAND\n"
                           ...
                           "END BLOCK\n"
                           "END LIBRARY\n");
  write(dir / "design.def", "# compact LEF/DEF fixture\n"
                            "VERSION 5.8 ;\n"
                            "DESIGN tiny_def ;\n"
...
Board parse_bookshelf_fixture(const std::filesystem::path &dir) {
  auto parser = make_parser();
  return parser->parse(dir / "tiny.aux");
}

Board parse_lefdef_fixture(const std::filesystem::path &dir) {
  LefDefParseOptions opts;
  opts.lef_files = {dir / "tech.lef", dir / "cells.lef"};
  auto parser = make_parser(std::move(opts));
  return parser->parse(dir / "design.def");
}
