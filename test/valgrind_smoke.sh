...
cell_density_svg="$work_dir/adaptec1-cell-density.svg"
...
echo "Running cell density renderer under Valgrind (adaptec1)..."
valgrind "${valgrind_flags[@]}" "$render_bin" --output-format cell-density-svg \
    "$binary" "$cell_density_svg"
